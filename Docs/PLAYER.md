...
|---|---|---|
| Walking speed | **10** u/s | Crosses the screen top to bottom in one second |
| Dash speed | **50** u/s | Five times the walk |
...
A dash is a short burst at five times walking speed. While it runs you are **invulnerable**, and the
