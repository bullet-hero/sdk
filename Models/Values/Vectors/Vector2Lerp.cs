...
namespace BH.SDK.Models.Values
{
    ...
    /// <summary>
    /// A 2D vector rolled along the straight segment from From to To: ONE roll, read by
    /// every axis at the same position. Vector2Rect is the same two points read as a box,
    /// rolled per axis.
    /// </summary>
    [RuleContainer]
    [GenerateModel]
    public sealed partial class Vector2Lerp : IVector2, IModel<Vector2Lerp>
    {
        ...
        public Vector2Lerp(float fromX, float fromY, float toX, float toY)
        {
            FromX = fromX;
            FromY = fromY;
