...
{
    /// <summary>
    /// Vector4RectUniform snapped to a grid: the shared roll decides the point on the diagonal, then
    /// each axis is quantized to its own grid.
    /// </summary>
    [RuleContainer]
    [RulePropertyOrder(nameof(Vector4RectStepUniform.MinX), nameof(Vector4RectStepUniform.MaxX))]
    [RulePropertyOrder(nameof(Vector4RectStepUniform.MinY), nameof(Vector4RectStepUniform.MaxY))]
    [RulePropertyOrder(nameof(Vector4RectStepUniform.MinZ), nameof(Vector4RectStepUniform.MaxZ))]
    [RulePropertyOrder(nameof(Vector4RectStepUniform.MinW), nameof(Vector4RectStepUniform.MaxW))]
    [GenerateModel]
    public sealed partial class Vector4RectStepUniform : IVector4, IModel<Vector4RectStepUniform>
    {
        ...
        public Vector4RectStepUniform(float minX, float minY, float minZ, float minW, 
